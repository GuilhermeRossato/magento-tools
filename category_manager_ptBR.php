<?php
$exporta1 = "Lista de produtos com categorias";
$exporta2 = "Lista de categorias sem raizes";
$exporta3 = "Lista completa de categorias";
$exporta4 = "Lista de produtos com preço";
$importa1 = "Associar produtos com categoria";
$importa2 = "Associar categorias pulando erros";
$importa3 = "Associar categorias criando se faltar";
$importa4 = "Associar produtos com preços";
$importa5 = "Associar preços pulando erros";
...
<html>
	<head>
		<meta charset="utf-8">
		<title>Ferramenta de Gerência de Categorias do Magento</title>
		<style>
	...
	<body>
		<div>
			<form target="_blank" method="post" enctype="multipart/form-data">
				<h1>Gerenciador de Categorias Externo do Magento</h1>
				<div class="half">
					<a class="pad">
						<h2>Exportar</h2>
						<div class="checkbox-wrapper" style="margin-bottom: 1px;">
							<input type="checkbox" name="isdownload" value="download" checked>
							<label for="isdownload">Baixar a lista</label>
							<span class="hint">Escolha entre baixar ou só visualizar o resultado da exportação no browser</span>
						</div>
						<input type="submit" name="submit" value="<?php echo $exporta3 ?>">
						<input type="submit" name="submit" value="<?php echo $exporta2 ?>" class="hinted">
						<span class="hint">Omite as categorias raízes (Root Category / Categoria Default) do inicio de cada linha</span>
				...
				<div class="half">
					<a class="pad">
						...
						<span class="hint">Envie uma tabela .csv com os skus e ids das categorias para associar, cabeçalho deve ser:<br>sku,categoria<br>Se um produto estiver em mais de uma categoria, precisa estar separado por virgula</span>
				...
				<div class="credits">Ferramenta desenvolvida por Guilherme Rossato para o Magento 1.9.2 em 20/12/2017</div>
			</form>
		</div>
		<script>
